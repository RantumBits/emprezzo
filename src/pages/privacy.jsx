...
const Privacy = content => (
  <Layout>
    ...
    <Header title="Privacy Policy">the fun stuff</Header>
    <Container left={content}>
    <div>
    <p>This Privacy Policy describes how Emprezzo  (the “Site” or “we”) collects, uses, and discloses your Personal Information when you visit sites, use apps and make purchases from  Emprezzo including emprezzo.com and the Empezzo browser extension.</p>
  ...
  <ul>
  <li><strong>Examples of Personal Information collected:</strong> name, email address, and phone number.</li>
...
<ul>
  ...
  <h2>Contact</h2>
  <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at hey@emprezzo.com or by mail using the details provided below:</p>
  <p>emprezzo, 329 Primrose #117181, Burlingame CA 94010, United States</p>
  Last updated: <i>2020-11-20</i>
  </div>
  </Container>
</Layout>
);
